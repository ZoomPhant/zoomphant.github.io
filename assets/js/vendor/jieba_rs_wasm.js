...
function load(module, imports) {
    if (typeof Response === 'function' && module instanceof Response) {
        return module.arrayBuffer().then(bytes => {
...
function init(input) {
    if (typeof input === 'undefined') {
        input = new URL(window.location.origin + '/assets/js/vendor/jieba_rs_wasm_bg.wasm');
    }
    const imports = {};
    imports.wbg = {};
    ...
    if (typeof input === 'string' || (typeof Request === 'function' && input instanceof Request) || (typeof URL === 'function' && input instanceof URL)) {
        input = fetch(input, { headers: { 'Content-Type': 'application/wasm' } });
    }

    Promise.resolve(input).then((r) => {
        load(r, imports).then(({ instance, module }) => {
            wasm = instance.exports;
            init.__wbindgen_wasm_module = module;
            window.jiebawasm.loaded = true;
        })
    })
